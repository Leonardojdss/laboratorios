...
def main():
    ...
    try:
       ...
       # Authenticate Face client
        ...
        if command == '1':
            DetectFaces(os.path.join('IA-VISION/face-detection/Python/face-api/images/','people.jpg'))
...
def DetectFaces(image_file):
    ...
    with open(image_file, mode="rb") as image_data:
        ...
        if len(detected_faces) > 0:
            ...
            plt.imshow(image)
            outputfile = 'IA-VISION/face-detection/Python/face-api/images/result/detected_faces.jpg'
