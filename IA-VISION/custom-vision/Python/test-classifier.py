...
def main():
    ...
    try:
        ...
        for image in os.listdir('IA-VISION/custom-vision/Python/test-classifier/test-images'):
            image_data = open(os.path.join('IA-VISION/custom-vision/Python/test-classifier/test-images',image), "rb").read()
